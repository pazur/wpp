...
\song[music={melodia ludowa},lyrics={piosenka ludowa\footnote{Wacław Denhoff-Czarnecki był autorem zwrotki siódmej i następnych, jak również opracowania całości. Autorstwo pierwszych sześciu zwrotek nie jest znane, przyjmuje się, że jest to piosenka ludowa.}}, beginonleft=true]
{O mój rozmarynie}
...
\begin{lyrics}[longestline={-- Otwieraj, nie bój się, to czwartacy.}]
