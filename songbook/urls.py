...
urlpatterns = patterns('songbook.views',
    ...
    url(r'^songbook/(?P<pk>[0-9]+)/latex/$', 'songbook_latex_view', name="songbook_latex"),
    url(r'^songbook/(?P<pk>[0-9]+)/latex/hash/$', 'songbook_latex_hash_view', name="songbook_latex_hash"),
